                    ...
                    <ul className="list-disc md:p1-10 p1-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                      {chapter.chapterContent.map((lecture,i)=>(
                        <li key={i} className="flex items-start gap-2 py-1">
                          <img src={false ? assets.blue_tick_icon : assets.play_icon} alt="play icon" className="w-4 h-4 m-1" />
          ...
          {playerData?(
            <div>
              ...
              <div className='flex justify-between items-center mt-1'>
                ...
                <button className='bg-blue-500 text-white px-4 py-2 rounded-md'>{false ? 'Completed' : 'Mark as completed'}</button>
              </div>
            </div>
          )
          :
